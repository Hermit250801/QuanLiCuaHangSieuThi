...
public class DangNhap extends JFrame {
	...
	private DangNhap() {
		...
		btnThoat.addActionListener(e->{
			int temp = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn thoát không?","Xác nhận thoát",JOptionPane.YES_NO_OPTION);
...
//			JOptionPane.showMessageDialog(this, "TÃ i khoáº£n hoáº·c máº­t kháº©u khÃ´ng chÃ­nh xÃ¡c");
//		}
//
