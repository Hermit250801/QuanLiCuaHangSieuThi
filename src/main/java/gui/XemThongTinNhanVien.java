...
//		}
		...
		{
			JLabel lblThmcGi = new JLabel("ThÃ´ng Tin NhÃ¢n ViÃªn");
		...
		lblDiaChi = new JLabel("TP Há»“ ChÃ­ MInh");
		lblDiaChi.setFont(new Font("Tahoma", Font.PLAIN, 18));
		
		JLabel lblTngTinPhng_1 = new JLabel("Ä�á»‹a chá»‰:");
		...
		JLabel lblXemChiTit = new JLabel("Xem chi tiáº¿t");
		...
		btnDoiPass = new JButton("Ä�á»•i máº­t kháº©u");
...
//		lblGioiTinh.setText(taiKhoan.getNhanVien().isGioiTinh()?"Nam":"Ná»¯");
//		
