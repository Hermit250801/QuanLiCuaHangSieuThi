...
//		}
		...
		modelSach = new DefaultTableModel(
				new String[] { "MÃ£ Ä‘á»™c giáº£", "Há»� tÃªn", "Giá»›i tÃ­nh", "Sá»‘ Ä‘iá»‡n thoáº¡i", "Ä�á»‹a chá»‰" }, 50) {
...
//					docGia.isGioiTinh() ? "Nam" : "Ná»¯", docGia.getSoDienThoai(), docGia.getDiaChi() });
//		}
//	}
...
//			if (selectRow == -1) {
//				JOptionPane.showMessageDialog(this, "Báº¡n chÆ°a chá»�n Ä‘á»™c giáº£!");
//				return;
//			}
