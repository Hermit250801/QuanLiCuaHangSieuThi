...
//		}
		...
		JLabel lblNewLabel_7 = new JLabel("MÃ£ tháº»");
		...
		mnXoa = new JMenuItem("XÃ³a ra khá»�i giá»� hÃ ng");
		popupMenu.add(mnXoa);
...
//					try {
//						/*
//						 * if (cboThe.getItemAt(0) != null) { return; } theThuVien =
//						 * theThuVienDao.getTheThuVien(soThe);
//						 * 
//						 * if (theThuVien != null) { cboThe.removeAllItems();
//						 * System.out.println(theThuVien); cboThe.addItem(theThuVien.getSoThe() + ": " +
//						 * theThuVien.getDocGia().getTenDocGia()); cboThe.showPopup();
//						 * 
//						 * } else { JOptionPane.showMessageDialog(null,
//						 * "KhÃ´ng tÃ¬m tháº¥y tháº» nÃ y"); }
//						 */
//
...
//			if (theThuVien == null) {
//				JOptionPane.showMessageDialog(null, "Vui lÃ²ng nháº­p tháº» thÆ° viá»‡n");
//				return;
//			}
...
////				this.dispose();
//			} catch (RemoteException e1) {
//				JOptionPane.showMessageDialog(null, "thÃªm tháº¥t báº¡i");
//				e1.printStackTrace();
//			}
//		});
