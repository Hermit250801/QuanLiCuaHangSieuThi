...
//		}
		...
		modelSach = new DefaultTableModel(
				new String[] { "STT", "Sá»‘ phiáº¿u", "MÃ£ nhÃ¢n viÃªn", "MÃ£ tháº»", "TÃªn Ä‘á»�c giáº£", "NgÃ y mÆ°á»£n", "Trang thai" },
				50) {
			@Override
...
//		headerTable.setBackground(new Color(160,227,242));
		...
		modelChiTiet = new DefaultTableModel(
				new String[] { "STT", "MÃ£ sÃ¡ch", "TÃªn sÃ¡ch", "TÃ¡c giáº£", "NgÃ y tráº£", "TÃ¬nh tráº¡ng" }, 20) {
			@Override
			public boolean isCellEditable(int row, int column) {
				return false;
			}
...
//				JOptionPane.showMessageDialog(this, "SÃ¡ch nÃ y Ä‘Ã£ Ä‘Æ°á»£c tráº£ vÃ o ngÃ y "+chiTietPhieuMuon.getNgayTra());
//				return;
//			}
...
//			}
//			if(b) {
//				JOptionPane.showMessageDialog(this, "Tráº£ sÃ¡ch thÃ nh cÃ´ng");
//			}
//			else JOptionPane.showMessageDialog(this, "Tráº£ sÃ¡ch tháº¥t báº¡i");
//			
//			
//		});
//		dayChoose.addPropertyChangeListener(e->{
...
//			lblTongTrang.setText("TrÃªn " + soTrang);
//		}
//	}
...
//						,kiemTraTrangThaiPhieuMuon(dsPhieuMuon.get(i))?"HoÃ n thÃ nh":"ChÆ°a hoÃ n thÃ nh"};
...
//							chiTiet.isTrangThaiTra() ? "Ä�Ã£ tráº£" : "ChÆ°a tráº£" };
...
//					,kiemTraTrangThaiPhieuMuon(ds.get(i))?"HoÃ n thÃ nh":"ChÆ°a hoÃ n thÃ nh"};
//			modelSach.addRow(row);
//		}
//		ChucNangChoTable.addNullDataTable(modelSach);
//	}
