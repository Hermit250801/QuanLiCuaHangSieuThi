...
//				JOptionPane.showMessageDialog(this, "SÃ¡ch nÃ y Ä‘ang cÃ²n");
//			} else {
//				dsSach.get(index).setTrangThai(true);
//				tblSach.setValueAt("CÃ²n", index, 6);
//				try {
//					sachDao.updateSach(dsSach.get(index));
//					JOptionPane.showMessageDialog(this, "Nháº­p thÃ nh cÃ´ng");
...
//			int index = tblSach.getSelectedRow();
//			if (!dsSach.get(index).isTrangThai()) {
//				JOptionPane.showMessageDialog(this, "SÃ¡ch Ä‘Ã£ háº¿t");
//			} else {
//				dsSach.get(index).setTrangThai(false);
//				tblSach.setValueAt("Háº¿t", index, 6);
//				try {
//					sachDao.updateSach(dsSach.get(index));
//					JOptionPane.showMessageDialog(this, "Cáº­p nháº­t háº¿t hÃ ng thÃ nh cÃ´ng");
//				} catch (RemoteException e1) {
//					e1.printStackTrace();
//				}
//			}
...
//						JOptionPane.showMessageDialog(this, "SÃ¡ch Ä‘Ã£ tá»“n táº¡i trong giá»�");
//						return;
//					}
//					if (sach.isTrangThai()) {
...
//					} else {
//						JOptionPane.showMessageDialog(null, "SÃ¡ch nÃ y Ä‘Ã£ háº¿t");
//					}
//				} catch (RemoteException e1) {
//					e1.printStackTrace();
//				}
...
////					sach.getNhaXuatBan().getTenNhaXuatBan(), sach.getNamXuatBan(), sach.isTrangThai() ? "CÃ²n" : "Háº¿t" };
