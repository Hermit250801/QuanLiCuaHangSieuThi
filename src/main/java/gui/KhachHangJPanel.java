...
public static void main(String[] args) {
	...
	frame.getContentPane().add(new KhachHangJPanel());
...
//	
		...
		lblNewLabel.setIcon(new ImageIcon(KhachHangJPanel.class.getResource("/img/reader (12).png")));
		...
		btnDangKy.setIcon(new ImageIcon(KhachHangJPanel.class.getResource("/img/plus_24.png")));
		...
		btnSua.setIcon(new ImageIcon(KhachHangJPanel.class.getResource("/img/sua.png")));
		...
		btnXoa.setIcon(new ImageIcon(KhachHangJPanel.class.getResource("/img/xoa.png")));
		...
		btnTim.setIcon(new ImageIcon(KhachHangJPanel.class.getResource("/img/search (1).png")));
		...
		btnDau_1_1.setIcon(new ImageIcon(KhachHangJPanel.class.getResource("/img/forward-button.png")));
		btnDau_1_1.setFont(new Font("Arial", Font.PLAIN, 16));
		
		JButton btnDau_2 = new JButton("");
		btnDau_2.setIcon(new ImageIcon(KhachHangJPanel.class.getResource("/img/next.png")));
		btnDau_2.setFont(new Font("Arial", Font.PLAIN, 16));
		
		JButton btnDau_2_1 = new JButton("");
		btnDau_2_1.setIcon(new ImageIcon(KhachHangJPanel.class.getResource("/img/rewind-button.png")));
		btnDau_2_1.setFont(new Font("Arial", Font.PLAIN, 16));
		
		JButton btnDau_1_1_1 = new JButton("");
		btnDau_1_1_1.setIcon(new ImageIcon(KhachHangJPanel.class.getResource("/img/previousEnd.png")));
