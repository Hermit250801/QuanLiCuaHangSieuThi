...
//		}
		...
		txtThngTinng.setText("ThÃ´ng tin Ä‘Äƒng nháº­p");
		...
		contentPanel.add(txtThngTinng);
		 ...
		 lblXacNhanMK = new JLabel("Máº­t kháº©u má»›i");
		...
		JLabel lblXcNhn = new JLabel("XÃ¡c nháº­n");
...
//						JOptionPane.showMessageDialog(this,"Ä�á»•i máº­t kháº©u thÃ nh cÃ´ng");
//						this.dispose();
...
//	}
	public boolean kiemTraMatKhauMoi() {
		...
		if(pass.matches("\\w{4,8}")) {
			...
			JOptionPane.showMessageDialog(this,"XÃ¡c nháº­n máº­t kháº©u má»›i tháº¥t báº¡i");
			return false;
		}
		else {
			JOptionPane.showMessageDialog(this, "Máº­t kháº©u tá»« 4-8 kÃ­ tá»±, khÃ´ng chá»©a kÃ­ tá»± Ä‘áº·c biá»‡t");
			return false;
		}
	}
...
//			return true;
//		JOptionPane.showMessageDialog(this,"Máº­t kháº©u cÅ© khÃ´ng chÃ­nh xÃ¡c");
//		return false;
//	}
