...
public class KhachHang extends JPanel implements ActionListener{
	...
	public KhachHang() {
		...
		btnTim.setIcon(new ImageIcon(KhachHang.class.getResource("/img/search (1).png")));
...
//		table_1 = new JTable();
		...
		/*
		 * HeaderRenderer renderer = new HeaderRenderer(); center JLabel headerLabel =
		 * (JLabel) renderer; headerLabel.setHorizontalAlignment(JLabel.CENTER);
		 * headerLabel.setFont(new Font("Tahoma", Font.BOLD, 14)); set color Header
		 * Table
		 */
...
//		}
		...
		btnDau_1_1_1.setIcon(new ImageIcon(KhachHang.class.getResource("/img/previousEnd.png")));
		btnDau_1_1_1.setFont(new Font("Arial", Font.PLAIN, 16));
		
		JButton btnDau_2_1 = new JButton("");
		btnDau_2_1.setIcon(new ImageIcon(KhachHang.class.getResource("/img/rewind-button.png")));
		...
		btnDau_1_1.setIcon(new ImageIcon(KhachHang.class.getResource("/img/nextbutton.png")));
		btnDau_1_1.setFont(new Font("Arial", Font.PLAIN, 16));
		
		JButton btnDau_2 = new JButton("");
		btnDau_2.setIcon(new ImageIcon(KhachHang.class.getResource("/img/nextEnd.png")));
	...
	public static void main(String[] args) {
		JFrame f = new JFrame();
		f.setSize(1920,918);
		f.getContentPane().add(new KhachHang());
		f.setVisible(true);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(object.equals(btnDangKy)) {
			new ThemNhanVienDialog().setVisible(true);
		}
